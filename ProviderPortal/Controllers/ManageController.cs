    ...
    public class ManageController : BaseController
    {
        ...
        public async Task<ActionResult> Index(ManageMessageId? message)
        {
            ViewBag.StatusMessage =
                message == ManageMessageId.ChangePasswordSuccess
                    ? AppGlobal.Language.GetText(this, "PasswordChanged", "Your password has been changed.")
                    : message == ManageMessageId.SetPasswordSuccess
                        ? AppGlobal.Language.GetText(this, "PasswordSet", "Your password has been set.")
                        : message == ManageMessageId.SetTwoFactorSuccess
                            ? AppGlobal.Language.GetText(this, "TwoFactorSet",
                                "Your two-factor authentication provider has been set.")
                            : message == ManageMessageId.Error
                                ? AppGlobal.Language.GetText(this, "AnErrorOccured", "An error has occurred.")
                                : message == ManageMessageId.AddPhoneSuccess
                                    ? AppGlobal.Language.GetText(this, "PhoneNumberAdded",
                                        "Your phone number was added.")
                                    : message == ManageMessageId.RemovePhoneSuccess
                                        ? AppGlobal.Language.GetText(this, "PhoneNumberRemoved",
        ...
        public async Task<ActionResult> VerifyPhoneNumber(VerifyPhoneNumberViewModel model)
        {
            ...
            ModelState.AddModelError("",
                AppGlobal.Language.GetText(this, "PhoneVerificationFailed", "Failed to verify phone"));
            return View(model);
        }
        ...
        public async Task<ActionResult> ManageLogins(ManageMessageId? message)
        {
            ViewBag.StatusMessage =
                message == ManageMessageId.RemoveLoginSuccess
                    ? AppGlobal.Language.GetText(this, "ExternalLoginRemoved", "The external login was removed.")
                    : message == ManageMessageId.Error
                        ? AppGlobal.Language.GetText(this, "AnErrorOccured", "An error has occurred.")
                        : "";
            var user = await UserManager.FindByIdAsync(User.Identity.GetUserId());
        ...
        //
        // GET: /Manage/Users
        [PermissionAuthorize(Permission.PermissionName.CanViewOrganisationUsers,
            Permission.PermissionName.CanViewOrganisationUsers, Permission.PermissionName.CanViewProviderUsers)]
        public ActionResult Users(string id)
        {
            ...
            var deferredLoad = userContext.ContextName == UserContext.UserContextName.Administration;
            var model = new ManageUsersViewModel(id);
            model.Populate(db, userContext, deferredLoad);
            return View(model);
        }

        //
        // GET: /Manage/UsersJson
        [PermissionAuthorize(Permission.PermissionName.CanViewOrganisationUsers,
            Permission.PermissionName.CanViewOrganisationUsers, Permission.PermissionName.CanViewProviderUsers)]
