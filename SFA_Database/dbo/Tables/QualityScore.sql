...
(
    ...
    CONSTRAINT [PK_QualityScore] PRIMARY KEY CLUSTERED ([ProviderId] ASC),
	CONSTRAINT [FK_QualityScore_Provider] FOREIGN KEY([ProviderId]) REFERENCES [Provider] ([ProviderId]),
	CONSTRAINT [FK_QualityScore_AspNetUser] FOREIGN KEY([AuditedByUserId]) REFERENCES [AspNetUsers] ([Id]),
	CONSTRAINT [FK_QualityScore_ModifiedByApplication] FOREIGN KEY([ModifiedByApplicationId]) REFERENCES [Application] ([ApplicationId]),
	CONSTRAINT [FK_QualityScore_ModifiedByAspNetUser] FOREIGN KEY([ModifiedByUserId]) REFERENCES [AspNetUsers] ([Id])
)
