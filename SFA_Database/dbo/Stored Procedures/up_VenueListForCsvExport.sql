...
SELECT 
	...
	LEFT OUTER JOIN AspNetUsers ANUModifiedBy ON V.ModifiedByUserId = ANUModifiedBy.Id
	LEFT OUTER JOIN AspNetUsers ANUCreatedBy ON V.CreatedByUserId = ANUCreatedBy.Id
	LEFT OUTER JOIN GeoLocation G ON A.Postcode = G.Postcode
	WHERE
